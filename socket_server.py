        ...
        while True:
            ...
            if message:
                ...
                if op_code == ";;":
                    ...
                    self.socket_con.send_string(f"{socket_emprestado_enviar} {socket_emprestado_receber}")
                    ...
                    self.socket_con.send_string("")#ack. pedido enviado
